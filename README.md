...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-elf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14465&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-elf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-elf` can be installed with:

```
conda install python-elf
```

It is possible to list all of the versions of `python-elf` available on your platform with:
